...
const ProjectsCard = ({ project }) => {
    ...
    return ( 
        <>
            <div className="cursor-pointer w-full relative overflow-hidden h-[250px] rounded-md group" style={{ backgroundColor: project.bgColor }} onClick={() => openModal(project)}
            >
                ...
                <img className="right-2 scale-125 top-5 absolute w-[250px] lg:group-hover:w-[500px]  lg:group-hover:h-auto transition-all duration-700 ease-out" src={project.image} alt="Photo"/>
            ...
            {isModalOpen && (                
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div class="relative mx-auto border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[90vh] sm:h-[85vh] max-w-[700px]">
                        ...
                        <div class="rounded-[2rem] h-[85vh] sm:h-[80vh] bg-gray-800 mt-5">  
